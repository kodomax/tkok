...
export const HEROES = {
  ...
  CHRONOWARPER: 'Chronowarper',
  DRUID: 'Druid',
  CHAOTIC_KNIGHT: 'Chaotic Knight',
...
export const STATS = {
  ...
  ATTACK_CRIT_CHANCE: 'Attack crit chance',
  ATTACK_CRIT_POWER: 'Attack crit power',
  SPELL_CRIT_CHANCE: 'Spell crit chance',
  SPELL_CRIT_POWER: 'Spell crit power',
  GOLD: 'Gold',
  EXP: 'Exp',
}
...
export const PERCENTAGE_STATS = [
  STATS.ATTACK_SPEED,
  STATS.ATTACK_CRIT_CHANCE,
  STATS.ATTACK_CRIT_POWER,
  STATS.BLOCK,
  STATS.SPELL_CRIT_CHANCE,
  STATS.SPELL_CRIT_POWER,
  STATS.MAGIC_RESIST,
  STATS.DODGE,
  STATS.GOLD,
  STATS.EXP,
